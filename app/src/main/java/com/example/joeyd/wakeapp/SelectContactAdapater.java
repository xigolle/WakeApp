 ...
 */
public class SelectContactAdapater extends BaseAdapter {
        ...
        public SelectContactAdapater(List<ContactDetails> selectUsers, Context context) {
            _data = selectUsers;
            _c = context;
...
//        @TargetApi(Build.VERSION_CODES.LOLLIPOP)
        ...
        public View getView(int i, View convertView, ViewGroup viewGroup) {
            ...
            final ContactDetails data = (ContactDetails) _data.get(i);
        ...
        public void filter(String charText) {
            ...
            if (charText.length() == 0) {
                ...
                for (ContactDetails wp : arraylist) {
